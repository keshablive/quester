...
type MarketplaceService struct {
	...
	// questRepo       *repositories.QuestRepository // TODO: Re-enable when quest repository is ready
...
func NewMarketplaceService(
	...
	return &MarketplaceService{
		...
		// questRepo:       questRepo, // TODO: Re-enable when quest repository is ready
		badgeRepo: badgeRepo,
	}
}
...
func (s *MarketplaceService) validateListingReferences(ctx context.Context, tenantID uuid.UUID, listing *models.MarketplaceListing) error {
	...
	// TODO: Re-enable when quest repository is ready
	...
	// TODO: Fix type mismatch - MarketplaceListing uses uint but Badge repository expects uuid.UUID
