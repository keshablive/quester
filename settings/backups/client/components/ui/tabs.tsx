 ...
 *
 * Implements FR-006: accessibilityRole="tab" for WCAG 4.1.2
 * Implements FR-010: Navigation state (selected) announcements
 */
  ...
  return (
    <TextClassContext.Provider
      ...
      <TabsPrimitive.Trigger
        ...
        accessibilityState={{ selected: value === props.value, disabled: props.disabled ?? false }}
        {...props}
      />
    </TextClassContext.Provider>
  );
