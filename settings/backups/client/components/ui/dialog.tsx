 ...
 * Dialog Component
 *
 * Implements FR-006: Modal accessibility with proper roles
 * Implements WCAG 2.4.3 Focus Order - focus trap within dialog
 *
 * Note: @rn-primitives/dialog handles accessibility internally including:
