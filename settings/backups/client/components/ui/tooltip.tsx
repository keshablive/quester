 ...
 * Tooltip Component
 *
 * Implements FR-009: accessibilityHint for complex interactions (WCAG 3.3.2)
 *
 * Note: @rn-primitives/tooltip handles accessibility internally.
 * Use accessibilityHint prop on TooltipTrigger for custom hints.
 */
