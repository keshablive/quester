 ...
 *
 * Implements FR-006: accessibilityRole="menu" for WCAG 4.1.2
 * Implements FR-009: Keyboard navigation support (long-press/right-click)
 *
 * Note: @rn-primitives/context-menu handles accessibility internally including:
 * - Menu roles and aria attributes
