 ...
 * Popover Component
 *
 * Implements FR-009: Accessible popover with aria-hidden management
 *
 * Note: @rn-primitives/popover handles accessibility internally including:
 * - accessibilityRole="menu" for content
