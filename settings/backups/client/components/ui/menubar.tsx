 ...
 * Menubar Component
 *
 * Implements FR-006: accessibilityRole="menubar" for WCAG 4.1.2
 * Implements FR-010: Navigation roles (horizontal menu navigation)
 *
 * Note: @rn-primitives/menubar handles accessibility internally including:
 * - Menubar/menu roles and aria attributes
