...
type AchievementRepository struct {
	*repository.GenericRepository[*models.Achievement]
...
func NewAchievementRepository(db *gorm.DB) *AchievementRepository {
	return &AchievementRepository{
		GenericRepository: repository.NewGenericRepository[*models.Achievement](db),
		db:                db,
	}
}

// Create creates a new achievement (interface-compliant method).
// Includes validation before delegating to GenericRepository.
func (r *AchievementRepository) Create(ctx context.Context, achievement *models.Achievement) error {
	if err := achievement.Validate(); err != nil {
		return utils.WrapCreateError(err, "achievement (validation)")
	}
	tenantCtx := withTenantContext(ctx, achievement.TenantID)
	if err := r.GenericRepository.Create(tenantCtx, achievement); err != nil {
		return utils.WrapCreateError(err, "achievement")
	}
	return nil
}

// FindByID retrieves an achievement by ID with tenant filtering
func (r *AchievementRepository) FindByID(ctx context.Context, tenantID, id uuid.UUID) (*models.Achievement, error) {
	...
	if err != nil {
		return nil, utils.WrapFindError(err, "achievement", id.String())
	}
...
func (r *AchievementRepository) FindByTenant(ctx context.Context, tenantID uuid.UUID) ([]models.Achievement, error) {
	...
	if err != nil {
		return nil, utils.WrapListError(err, "achievements")
	}
...
// Update updates an achievement (interface-compliant method).
// Includes validation before delegating to GenericRepository.
func (r *AchievementRepository) Update(ctx context.Context, achievement *models.Achievement) error {
	...
	tenantCtx := withTenantContext(ctx, achievement.TenantID)
	if err := r.GenericRepository.Update(tenantCtx, achievement); err != nil {
		return utils.WrapUpdateError(err, "achievement")
	}
	return nil
}
...
func (r *AchievementRepository) Delete(ctx context.Context, id uuid.UUID) error {
	return utils.WrapDeleteError(r.db.WithContext(ctx).
		Model(&models.Achievement{}).
		Where("id = ?", id).
		Update("active", false).Error, "achievement")
}
...
func (r *AchievementRepository) CreateUserAchievement(ctx context.Context, userAchievement *models.UserAchievement) error {
	return utils.WrapCreateError(r.db.WithContext(ctx).Create(userAchievement).Error, "user_achievement")
}
...
func (r *AchievementRepository) FindUserAchievement(ctx context.Context, userID, achievementID uuid.UUID) (*models.UserAchievement, error) {
	...
	if err != nil {
		return nil, utils.WrapFindError(err, "user_achievement", userID.String()+":"+achievementID.String())
	}
...
func (r *AchievementRepository) FindUserAchievements(ctx context.Context, userID uuid.UUID, completedOnly bool) ([]models.UserAchievement, error) {
	...
	return userAchievements, utils.WrapListError(err, "user_achievements")
}

// FindOrCreateUserAchievement finds existing or creates new user achievement progress
func (r *AchievementRepository) FindOrCreateUserAchievement(ctx context.Context, tenantID, userID, achievementID uuid.UUID) (*models.UserAchievement, error) {
	...
	achievement, err := r.FindByID(ctx, tenantID, achievementID)
	if err != nil {
		return nil, utils.WrapFindError(err, "achievement", achievementID.String())
	}
...
func (r *AchievementRepository) UpdateUserAchievementProgress(ctx context.Context, userAchievement *models.UserAchievement) error {
	return utils.WrapUpdateError(r.db.WithContext(ctx).Save(userAchievement).Error, "user_achievement")
}
...
func (r *AchievementRepository) UpdateStepProgress(ctx context.Context, userAchievementID, stepID uuid.UUID, completed bool) error {
	...
	return utils.WrapUpdateError(r.db.WithContext(ctx).
		...
		Updates(updates).Error, "user_achievement_step_progress")
}
...
func (r *AchievementRepository) GetAchievementStats(ctx context.Context, userID uuid.UUID) (map[string]interface{}, error) {
	...
	if err := r.db.WithContext(ctx).
		...
		return nil, utils.WrapCountError(err, "total achievements")
	}
	...
	if err := r.db.WithContext(ctx).
		...
		return nil, utils.WrapCountError(err, "completed achievements")
	}
	...
	if err := r.db.WithContext(ctx).
		...
		return nil, utils.WrapCountError(err, "in-progress achievements")
	}
	...
	if err := r.db.WithContext(ctx).
		...
		return nil, utils.WrapCountError(err, "total XP earned")
	}
...
func (r *AchievementRepository) CreateUserAchievementBadge(ctx context.Context, tenantID, userID, achievementID, badgeID uuid.UUID) error {
	...
	// Verify achievement exists and belongs to tenant
	if _, err := r.FindByID(ctx, tenantID, achievementID); err != nil {
		return utils.WrapFindError(err, "achievement", achievementID.String())
	}

	return utils.WrapCreateError(r.db.WithContext(ctx).Create(rec).Error, "user_achievement_badge")
}
