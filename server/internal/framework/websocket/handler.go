...
const (
	...
	// Learning Gamification WebSocket events (T101)
	MessageTypeLearningXPAwarded           = "learning_xp_awarded"
	MessageTypeLearningLevelUp             = "learning_level_up"
	MessageTypeLearningAchievementUnlocked = "learning_achievement_unlocked"
	MessageTypeLearningStreakMilestone     = "learning_streak_milestone"
	MessageTypeLearningChallengeCompleted  = "learning_challenge_completed"
	MessageTypeLearningChallengeProgress   = "learning_challenge_progress"
)
...
// SendLearningXPAwarded sends XP award notification to a user
func (h *Handler) SendLearningXPAwarded(userID, tenantID string, data map[string]interface{}) {
	msg := &Message{
		Type:      MessageTypeLearningXPAwarded,
		Data:      data,
		Timestamp: time.Now(),
	}
	h.sendToUser(userID, tenantID, msg)
...
// SendLearningLevelUp sends level-up notification to a user
func (h *Handler) SendLearningLevelUp(userID, tenantID string, data map[string]interface{}) {
	msg := &Message{
		Type:      MessageTypeLearningLevelUp,
		Data:      data,
		Timestamp: time.Now(),
	}
	h.sendToUser(userID, tenantID, msg)
...
// SendLearningAchievementUnlocked sends achievement unlock notification to a user
func (h *Handler) SendLearningAchievementUnlocked(userID, tenantID string, data map[string]interface{}) {
	msg := &Message{
		Type:      MessageTypeLearningAchievementUnlocked,
		Data:      data,
		Timestamp: time.Now(),
	}
	h.sendToUser(userID, tenantID, msg)
...
// SendLearningStreakMilestone sends streak milestone notification to a user
func (h *Handler) SendLearningStreakMilestone(userID, tenantID string, data map[string]interface{}) {
	msg := &Message{
		Type:      MessageTypeLearningStreakMilestone,
		Data:      data,
		Timestamp: time.Now(),
	}
	h.sendToUser(userID, tenantID, msg)
...
// SendLearningChallengeCompleted sends challenge completion notification to a user
func (h *Handler) SendLearningChallengeCompleted(userID, tenantID string, data map[string]interface{}) {
	msg := &Message{
		Type:      MessageTypeLearningChallengeCompleted,
		Data:      data,
		Timestamp: time.Now(),
	}
	h.sendToUser(userID, tenantID, msg)
...
// SendLearningChallengeProgress sends challenge progress update to a user
func (h *Handler) SendLearningChallengeProgress(userID, tenantID string, data map[string]interface{}) {
	msg := &Message{
		Type:      MessageTypeLearningChallengeProgress,
		Data:      data,
		Timestamp: time.Now(),
	}
	h.sendToUser(userID, tenantID, msg)
