...
const (
	...
	QueueSocialXP       = "queue:social:xp"
)

// Job types for social gamification (FR-013: Async batch processing)
const (
	JobTypeSocialXP         = "social_xp_award"
	JobTypeDailyChallengeXP = "daily_challenge_xp"
	JobTypeContentMilestone = "content_milestone"
	JobTypePerfectDayBonus  = "perfect_day_bonus"
)
...
func (s *QueueService) getQueueName(jobType string) string {
	...
	case JobTypeSocialXP, JobTypeDailyChallengeXP, JobTypeContentMilestone, JobTypePerfectDayBonus:
		return QueueSocialXP
	default:
		return QueueDefault
	}
}
